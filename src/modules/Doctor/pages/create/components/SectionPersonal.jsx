      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg  focus:ring-gray-300  ${
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-3 py-2 border rounded-lg  focus:ring-gray-300 focus:border-transparent ${
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg  focus:ring-gray-300 focus:border-transparent"
          />
        </div>
        ...
        <div>
          <label className="block  font-medium text-gray-700 mb-1">Languages Spoken</label>
          <input
            type="text"
            name="languages"
